...
import Skills from '../candidate/components/skills'
import Education from '../candidate/components/education'
import Experiences from '../candidate/components/experiences'
